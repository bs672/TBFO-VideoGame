...
public class GDXRoot extends Game implements ScreenListener {
	...
	public void create() {
		...
		controllers[5] = new PlayMode("Tutorial");
		controllers[6] = new PlayMode("Intro Level 1");
		controllers[7] = new PlayMode("Intro Level 2");
		controllers[8] = new PlayMode("Intro Level 3");
