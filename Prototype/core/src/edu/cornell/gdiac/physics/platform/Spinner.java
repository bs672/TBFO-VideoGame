...
public class Spinner extends ComplexObstacle {
	...
	public Spinner(float x, float y, float width, float height) {
		...
		WheelObstacle spin = new WheelObstacle(x, y, SPIN_PIN_RADIUS);
		spin.setName("Spin Axis");
		spin.setDensity(LIGHT_DENSITY);
		spin.setBodyType(BodyDef.BodyType.StaticBody);
		bodies.add(spin);
        //#endregion
    }
	...
	protected boolean createJoints(World world) {
		...
		// Joint connecting spin axis to platform
